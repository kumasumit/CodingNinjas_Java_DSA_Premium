...
9 8 2 0 0 
*/
public class PushZerosToEndWithTemp{
    //basic solution code
    public static void pushZerosAtEndWithTemp(int[] arr) {
    	//Your code goes here
        int n = arr.length;
        int temp[] = new int[n];
        int j=0;
        ...
        //printArray(temp); checks whether we get the required output
        //now copy items from temp into arr
        for(int i=0;i<n;i++){
            arr[i] = temp[i];
